...
public interface DoubleConsumer {
    ...
    class Util {
         ...
         * @since 1.1.7
         * @see #safe(com.jrodiz.stream.function.ThrowableDoubleConsumer, com.jrodiz.stream.function.DoubleConsumer)
         */
         ...
         * @throws NullPointerException if {@code throwableConsumer} is null
         * @since 1.1.7
         * @see #safe(com.jrodiz.stream.function.ThrowableDoubleConsumer)
         */
        public static DoubleConsumer safe(
