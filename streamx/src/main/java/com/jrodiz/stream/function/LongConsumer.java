...
public interface LongConsumer {
    ...
    class Util {
         ...
         * @since 1.1.7
         * @see #safe(com.jrodiz.stream.function.ThrowableLongConsumer, com.jrodiz.stream.function.LongConsumer)
         */
         ...
         * @throws NullPointerException if {@code throwableConsumer} is null
         * @since 1.1.7
         * @see #safe(com.jrodiz.stream.function.ThrowableLongConsumer)
         */
        public static LongConsumer safe(
