...
import com.jrodiz.stream.function.*;
import com.jrodiz.stream.internal.Compose;
import com.jrodiz.stream.internal.Operators;
import com.jrodiz.stream.internal.Params;
import com.jrodiz.stream.iterator.IndexedIterator;
import com.jrodiz.stream.iterator.LazyIterator;
import com.jrodiz.stream.operator.*;
...
//<editor-fold defaultstate="collapsed" desc="Implementation">
     ...
     * @see #map(com.jrodiz.stream.function.Function)
     */
    @NotNull
     ...
     * @param mapper  the mapper function used to apply to each element
     * @return the new {@code IntStream}
     * @see #flatMap(com.jrodiz.stream.function.Function)
     */
    @NotNull
     ...
     * @param accumulator  the accumulation function
     * @return the result of the reduction
     * @see #reduce(java.lang.Object, com.jrodiz.stream.function.BiFunction)
     */
    @NotNull
     ...
     * @see #toArray(com.jrodiz.stream.function.IntFunction)
     */
    @NotNull
     ...
     * @param accumulator  the accumulation function
     * @return the result of collect elements
     * @see #collect(com.jrodiz.stream.Collector)
     */
    @Nullable
     ...
     * @return the result of collect elements
     * @see #collect(com.jrodiz.stream.function.Supplier, com.jrodiz.stream.function.BiConsumer)
     */
    @Nullable
