...
public final class DoubleStream implements Closeable {
     ...
     * @see Stream#custom(com.jrodiz.stream.function.Function)
     ...
     * @return the new stream
     * @see Stream#map(com.jrodiz.stream.function.Function)
     */
    @NotNull
     ...
     * @param mapper  the mapper function used to apply to each element
     * @return the new stream
     * @see Stream#flatMap(com.jrodiz.stream.function.Function)
     */
    @NotNull
     ...
     * @param accumulator  the accumulation function
     * @return the result of the reduction
     * @see #reduce(com.jrodiz.stream.function.DoubleBinaryOperator)
     */
    @NotNull
     ...
     * @see Stream#collect(com.jrodiz.stream.function.Supplier, com.jrodiz.stream.function.BiConsumer)
     */
    @Nullable
